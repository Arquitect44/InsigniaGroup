    ...
    <section className="relative bg-[#1a1a1a] h-screen">
      ...
      <div className="relative z-20 max-w-[2000px] mx-auto px-4 md:px-6 lg:px-8 h-full flex items-center">
        ...
        >
          ...
          >
            From initial vision to final delivery, we control every stage of development ensuring uncompromising quality across 43 prestigious buildings throughout New York City.
          </motion.p>
