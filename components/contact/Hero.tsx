...
export default function Hero() {
  return (
    <section className="relative bg-[#1a1a1a] min-h-[50vh] flex items-center">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 max-w-[2000px] mx-auto px-4 md:px-6 lg:px-8 py-16 lg:py-24 w-full">
        <motion.div
          className="max-w-4xl"
