      ...
      <div className="relative z-10 max-w-[2000px] mx-auto px-4 md:px-6 lg:px-8 py-20 lg:py-32 w-full">
        ...
        >
          ...
          <h1 className="text-white mb-8 leading-tight">
            ...
            <br />
            <span className="font-bold">Single accountability.</span>
          </h1>
          ...
          >
            From capital deployment through long-term asset management, we maintain complete control over every aspect of development. No outsourcing. No compromises.
          </motion.p>
        </motion.div>
      </div>
    </section>
